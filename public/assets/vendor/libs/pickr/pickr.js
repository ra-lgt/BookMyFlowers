                ...
                var t = {
                    ...
                    7022: (t, e, r) => {
                      ...
                      t.exports = function (t) {
                        ...
                        var y,
                          ...
                          O = 0;
                        if (!_ || (this === v && c(_)))
                          for (y = s(e), b = r ? new this(y) : v(y); y > O; O++)
                            (S = g ? d(e[O], O) : e[O]), l(b, O, S);
                        else
                          for (
                            b = r ? new this() : [], w = (x = p(e, _)).next;
                            !(m = o(w, x)).done;
                            O++
                          )
                    ...
                    60: (t, e, r) => {
                      ...
                      t.exports = function (t, e) {
                        if (!delete t[e])
                          throw new o(
                            "Cannot delete property " + n(e) + " of " + n(t)
                          );
                      };
                    },
                    1870: (t, e, r) => {
                    ...
                    654: (t, e, r) => {
                      ...
                      t.exports = function (t, e, r, a, h, g, E) {
                        ...
                        if (
                          (N &&
                            (j = s(N.call(new t()))) !== Object.prototype &&
                            j.next &&
                            (i ||
                              s(j) === m ||
                              (l ? l(j, m) : c(j[w]) || v(j, w, A)),
                            p(j, I, !0, !0),
                            i && (d[I] = A)),
                          y &&
                            h === _ &&
                          ...
                          else n({ target: e, proto: !0, forced: x || R }, C);
                        return (
                          (i && !E) || T[w] === F || v(T, w, F, { name: h }),
                          (d[e] = F),
                          C
                        );
                      };
                      ...
                      e.f =
                        n && !o
                          ...
                          : function (t, e) {
                              a(t);
                              for (
                                var r, n = c(e), o = u(e), s = o.length, l = 0;
                                s > l;
                    ...
                    4008: (t, e, r) => {
                      var n = r(3076),
                        o = r(9603).map;
                      n(
                        { target: "Array", proto: !0, forced: !r(9331)("map") },
                        {
                          map: function (t) {
                            return o(
                              this,
                    ...
                    2264: (t, e, r) => {
                      var n = r(3076),
                        ...
                        j = function (t, e, r) {
                          var n = y(r, e - 1),
                            o = y(r, e + 1);
                          return (g(S, t) && !g(_, o)) || (g(_, t) && !g(S, n))
                            ? "\\u" + x(b(t, 0), 16)
                            : t;
                        };
                      d &&
                    ...
                    5746: (t, e, r) => {
                      var n = r(3076),
                        ...
                        g = function (t, e, r) {
                          for (var n = -1, o = r; ++n < 6; )
                            (o += e * t[n]), (t[n] = o % 1e7), (o = p(o / 1e7));
                        },
                        y = function (t, e) {
                          for (var r = 6, n = 0; --r >= 0; )
                            (n += t[r]), (t[r] = p(n / e)), (n = (n % e) * 1e7);
                        },
                        b = function (t) {
                          for (var e = 6, r = ""; --e >= 0; )
                            if ("" !== r || 0 === e || 0 !== t[e]) {
                        ...
                        return [
                          ...
                          function (t) {
                            ...
                            for (
                              ...
                              (v[h] = d),
                                "" === d &&
                                  (n.lastIndex = p(o, c(n.lastIndex), s)),
                                h++;
                            }
                            return 0 === h ? null : v;
                          },
                    ...
                    9666: (t, e, r) => {
                      var n = r(3076),
                        o = r(8155).start;
                      n(
                        { target: "String", proto: !0, forced: r(7285) },
                        {
                          padStart: function (t) {
                            return o(
                              this,
                        ...
                        function (t, e, r) {
                          ...
                          return [
                            ...
                            function (t, o) {
                              ...
                              for (
                                var E, j = [];
                                null !== (E = b(a, c)) && (_(j, E), m);

                              )
                                "" === v(E[0]) &&
                                  (a.lastIndex = d(c, f(a.lastIndex), g));
                              for (
                                var C, k = "", P = 0, I = 0;
                                I < j.length;
                                I++
                      ...
                      s ||
                        (j(
                          (Y = (z = function () {
                            ...
                            return (
                              u && it && ct(W, e, { configurable: !0, set: r }),
                              ut(e, t)
                            );
                          })[G]),
                          "toString",
                        ...
                        u &&
                          ...
                          c ||
                            j(W, "propertyIsEnumerable", pt, { unsafe: !0 }))),
                        n(
                          {
                            global: !0,
                            constructor: !0,
                ...
                return (
                  (() => {
                    ...
                    function i(t, r, n, o, i) {
                      void 0 === i && (i = {}),
                        r instanceof HTMLCollection || r instanceof NodeList
                          ? (r = Array.from(r))
                          : Array.isArray(r) || (r = [r]),
                        Array.isArray(n) || (n = [n]);
                      for (var a, c = e(r); !(a = c()).done; )
                        for (var u, s = a.value, l = e(n); !(u = l()).done; ) {
                          var p = u.value;
                          s[t](p, o, Object.assign({ capture: !1 }, i));
                        }
                    ...
                    function f(t, e) {
                      ...
                      void 0 === e &&
                        ...
                        a(t, "focus", function () {
                          return a(window, "wheel", r, { passive: !1 });
                        }),
                        a(t, "blur", function () {
                      ...
                      var e = {
                          ...
                          _tapmove: function (t) {
                            ...
                            if (t) {
                              ...
                              n && ((c = n.x * a.width), (u = n.y * a.height));
                            "h" !== o &&
                              (i.style.left =
                                "calc(" +
                                (c / a.width) * 100 +
                        ...
                        o = e._keyboard;
                      return (
                        a([r.wrapper, r.element], "mousedown", n),
                        ...
                        (this._nanopop = ((t, e, r) => {
                          const n =
                            "object" != typeof t || t instanceof HTMLElement
                              ? { reference: t, popper: e, ...r }
                              : t;
                          return {
                            update(t = n) {
                              const { reference: e, popper: r } = Object.assign(
                                n,
                                t
                              );
                              if (!r || !e)
                              ...
                              return ((t, e, r) => {
                                ...
                                return (
                                  (e.style.left = l), (e.style.top = p), null
                                );
                              })(e, r, n);
                            },
                          };
                                  ...
                                  if (r.palette) {
                                    ...
                                    (this.element.style.background = p),
                                      ...
                                      a.comparison
                                        ? a.useAsButton ||
                                          e._lastColor ||
                                          s.style.setProperty("--pcr-color", p)
                                        : (i.button.style.setProperty(
                                            "--pcr-color",
                                            p
                                          ),
                                  ...
                                  switch (o) {
                                    case "cmyk":
                                      ...
                                      if (
                                        ...
                                        break t;
                                      return { values: m(a, c, u, s), type: o };
                                    case "rgba":
                                      var l = n(e),
                                        p = l[1],
                                        f = l[3],
