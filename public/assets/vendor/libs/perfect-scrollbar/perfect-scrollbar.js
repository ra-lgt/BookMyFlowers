          ...
          t.exports = (function () {
            ...
            function h(t, e) {
              a[e] = setTimeout(function () {
                return (
                  t.isAlive && t.element.classList.remove(s.state.scrolling(e))
                );
              ...
              (t.reach[a] = null),
                ...
                e &&
                  ...
                  e < 0
                    ...
                    : e > 0 && d.dispatchEvent(b("ps-scroll-" + h)),
                  i && u(t, a)),
                t.reach[a] &&
                  (e || n) &&
                  d.dispatchEvent(b("ps-" + a + "-reach-" + t.reach[a]));
            }
            function m(t) {
            ...
            function L(t) {
              ...
              (t.containerWidth = Math.floor(i.width)),
                ...
                e.contains(t.scrollbarXRail) ||
                  (o(e, s.element.rail("x")).forEach(function (t) {
                    return l(t);
                  }),
                  e.appendChild(t.scrollbarXRail)),
                e.contains(t.scrollbarYRail) ||
                  (o(e, s.element.rail("y")).forEach(function (t) {
                    return l(t);
                  }),
            ...
            function S(t, e) {
              ...
              function m(e) {
                e.touches &&
                  e.touches[0] &&
                  (e[n] = e.touches[0]["page" + d.toUpperCase()]),
                  R === o &&
                    ((p[u] = b + v * (e[n] - g)),
                    c(t, d),
                    L(t),
              ...
              t[o].addEventListener("mousedown", y),
                t[o].addEventListener("touchstart", y);
            }
            function H(t) {
              var e = t.element,
                r = function () {
            ...
            function M(e) {
              ...
              function n(t) {
                ...
                return (
                  (void 0 !== e && void 0 !== r) ||
                    ((e = (-1 * t.wheelDeltaX) / 6), (r = t.wheelDeltaY / 6)),
              ...
              function l(e, i, n) {
                ...
                for (var l = e; l && l !== r; ) {
                  ...
                  if (n && o.overflowY.match(/(scroll|auto)/)) {
                    ...
                    if (
                      a > 0 &&
                      ((l.scrollTop > 0 && n < 0) || (l.scrollTop < a && n > 0))
                    )
                      return !0;
                  }
                ...
                if (!l(t.target, s, a)) {
                  ...
                  e.settings.useBothWheelAxes
                    ? e.scrollbarYActive && !e.scrollbarXActive
                      ? (a
                          ? (r.scrollTop -= a * e.settings.wheelSpeed)
                          : (r.scrollTop += s * e.settings.wheelSpeed),
                        (c = !0))
                      : e.scrollbarXActive &&
                        !e.scrollbarYActive &&
                        (s
                          ? (r.scrollLeft += s * e.settings.wheelSpeed)
                          : (r.scrollLeft -= a * e.settings.wheelSpeed),
                        (c = !0))
                    : ((r.scrollTop -= a * e.settings.wheelSpeed),
                      (r.scrollLeft += s * e.settings.wheelSpeed)),
                    L(e),
            ...
            function x(e) {
              if (X.supportsTouch || X.supportsIePointer) {
                ...
                X.supportsTouch
                  ? (e.event.bind(r, "touchstart", c),
                    e.event.bind(r, "touchmove", u),
                    e.event.bind(r, "touchend", d))
                  : X.supportsIePointer &&
                    (window.PointerEvent
              ...
              function a(t) {
                return !(
                  t.target === e.scrollbarX ||
                  t.target === e.scrollbarY ||
                  (t.pointerType &&
                    "pen" === t.pointerType &&
                    0 === t.buttons) ||
                ...
                e.settings.swipeEasing &&
                  ...
                  (i.easingLoop = setInterval(function () {
                    e.isInitialized
                      ? clearInterval(i.easingLoop)
                      : i.speed.x || i.speed.y
                      ? Math.abs(i.speed.x) < 0.01 && Math.abs(i.speed.y) < 0.01
                        ? clearInterval(i.easingLoop)
                        : (l(30 * i.speed.x, 30 * i.speed.y),
                          (i.speed.x *= 0.8),
                          (i.speed.y *= 0.8))
                      : clearInterval(i.easingLoop);
                  }, 10)));
              ...
              k = function (i, n) {
                ...
                (this.scrollbarXBottom = parseInt(d.bottom, 10)),
                  ...
                  (this.railBorderXWidth =
                    m(d.borderLeftWidth) + m(d.borderRightWidth)),
                ...
                (this.scrollbarYRight = parseInt(f.right, 10)),
                  ...
                  (this.railBorderYWidth =
                    m(f.borderTopWidth) + m(f.borderBottomWidth)),
