(async () => {
  let o = document.querySelector(".kanban-update-item-sidebar"),
    e = document.querySelector(".kanban-wrapper"),
    t = document.querySelector(".comment-editor"),
    n = document.querySelector(".kanban-add-new-board"),
    r = [].slice.call(document.querySelectorAll(".kanban-add-board-input")),
    a = document.querySelector(".kanban-add-board-btn"),
    d = document.querySelector("#due-date"),
    s = $(".select2"),
    i = document.querySelector("html").getAttribute("data-assets-path"),
    l = new bootstrap.Offcanvas(o);
  function c(e) {
    return e.id
      ? "<div class='badge " +
...
`,
      ...
      document.querySelector('.ql-editor').innerHTML=e.getAttribute('data-comments')
        ...
        if (dueDateInput && typeof flatpickr !== "undefined") {
          ...
          o.querySelector(".assigned").insertAdjacentHTML(
            "afterbegin",
            u(d, !1, "xs", "1", e.getAttribute("data-members")) +
              `
            ...
            p.addElement(a, {
              ...
              Array.from(
                ...
                t.addEventListener("click", () => {
                  var e = t.closest(".kanban-item").getAttribute("data-eid");
                  p.removeElement(e);
                });
              }),
              n.remove();
  ...
  var g = Array.from(document.querySelectorAll(".kanban-title-board")),
    ...
    f.forEach((e) => {
      ...
      e.getAttribute("data-image") &&
        ...
        e.getAttribute("data-badge") &&
          e.getAttribute("data-badge-text") &&
...
` +
        ...
        (e.getAttribute("data-comments") ||
          e.getAttribute("data-due-date") ||
          e.getAttribute("data-assigned")) &&
          e.insertAdjacentHTML(
            "beforeend",
            ((t = e.getAttribute("data-attachments") || 0),
            (a = e.getAttribute("data-comments") || 0),
...
`)
    ...
    (f = Array.from(document.querySelectorAll(".kanban-tasks-item-dropdown")))
      .length &&
      f.forEach((e) => {
    ...
    Array.from(document.querySelectorAll(".delete-board")).forEach((t) => {
      t.addEventListener("click", () => {
        var e = t.closest(".kanban-board").getAttribute("data-id");
        p.removeBoard(e);
      });
    }),
    Array.from(document.querySelectorAll(".delete-task")).forEach((t) => {
      t.addEventListener("click", () => {
        var e = t.closest(".kanban-item").getAttribute("data-eid");
        p.removeElement(e);
      });
    }),
    (f = document.querySelector(".kanban-add-board-cancel-btn")) &&
    ...
    n &&
      n.addEventListener("submit", (e) => {
        e.preventDefault();
        var e = e.target.querySelector(".form-control").value.trim(),
          a = e.replace(/\s+/g, "-").toLowerCase(),
          a =
            (p.addBoards([{ id: a, title: e }]),
            document.querySelector(".kanban-board:last-child"));
        if (a) {
          let e = a.querySelector(".kanban-title-board"),
            t =
              (e.insertAdjacentHTML("afterend", b()),
              e.addEventListener("mouseenter", () => {
                e.contentEditable = "true";
              }),
              a.querySelector(".delete-board"));
          t &&
            t.addEventListener("click", () => {
              var e = t.closest(".kanban-board").getAttribute("data-id");
              p.removeBoard(e);
    ...
    o.addEventListener("hidden.bs.offcanvas", () => {
      var e = o.querySelector(".ql-editor").firstElementChild;
      e && (e.innerHTML = "");
    }),
    o &&
      o.addEventListener("shown.bs.offcanvas", () => {
        Array.from(o.querySelectorAll('[data-bs-toggle="tooltip"]')).forEach(
          (e) => {
            new bootstrap.Tooltip(e);
          }
        );
