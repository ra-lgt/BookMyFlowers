 ...
 *   https://datatables.net/download/#dt/dt-1.13.8/af-2.6.0
 *
 * Included libraries:
                ...
                m.each(a, function (t, e) {
                  i.append(
                    m("<button/>")
                      .html(s[e].option(l, o))
                      .append(
                        m('<span class="dt-autofill-button"/>').html(
...
!(function (n) {
  ...
  "function" == typeof define && define.amd
    ? define(
        ["jquery", "datatables.net-dt", "datatables.net-autofill"],
        function (e) {
    ...
    ? ((o = require("jquery")),
      ...
      "undefined" == typeof window
        ? (module.exports = function (e, t) {
            return (
              (e = e || window), (t = t || o(e)), d(e, t), n(t, 0, e.document)
            );
          })
