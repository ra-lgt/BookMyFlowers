!(function () {
  ...
  var o = 86400,
    u = { bubbles: !0, cancelable: !1, detail: null };
  function c(e, t) {
      ...
      return (
        ...
        (c = [
          ...
          },
          {
            ...
            value: function () {
              var e,
                t = l(document.getElementsByClassName("ui-timepicker-input"));
              try {
                for (t.s(); !(e = t.n()).done; ) {
        ...
        (a = [
          {
            ...
            value: function () {
              ...
              else if (this.list && n.isVisible(this.list)) {
            ...
            value: function (e, t) {
              ...
              if (this.selectedValue != e) {
                ...
                var r = new CustomEvent("changeTime", u),
                  s = new CustomEvent(
                    "change",
                    Object.assign(u, { detail: "timepicker" })
                  );
                return (
                  "select" == t
          ...
          },
          {
            ...
            value: function (t) {
              return "number" == typeof t
                ...
                : "string" == typeof t
                ? this.time2int(t)
                : "object" === e(t) && t instanceof Date
                ? 3600 * t.getHours() + 60 * t.getMinutes() + t.getSeconds()
                : "function" == typeof t
                ? t()
                : null;
            },
          },
          {
            ...
            value: function (e) {
              ...
              (e = e.toLowerCase().replace(/[\s\.]/g, "")),
                "am" !== this.settings.lang.am ||
                  ("a" != e.slice(-1) && "p" != e.slice(-1)) ||
                  (e += "m");
              var t =
              ...
              r || 2 != i[3].length || "0" != i[3][0] || (r = "am"),
                n > 24 &&
                  !s &&
                  ((n = 1 * i[3][0]), (s = this.parseMinuteString(i[3][1])));
              var l = n;
              if (n <= 12 && r) {
                var u =
          ...
          },
          {
            ...
            value: function (e) {
              if (
                ((e.lang = s(s({}, f), e.lang)),
                (this.settings = e),
                e.listWidth && (e.listWidth = this.anytime2int(e.listWidth)),
              ...
              return (
                ...
                e.closeOnWindowScroll &&
                  !e.closeOnScroll &&
                  (e.closeOnScroll = e.closeOnWindowScroll),
                !0 === e.closeOnScroll && (e.closeOnScroll = window.document),
                e
              );
            },
          },
          {
            ...
            value: function (e) {
              ...
              for (var t in e)
                e[t] = [this.anytime2int(e[t][0]), this.anytime2int(e[t][1])];
              for (
                t =
            ...
            value: function (e, t) {
              ...
              return (
                r < 60
                  ...
                  : ((i = Math.floor(r / 60)),
                    (n = r % 60),
                    30 == t && 30 == n && (i += this.settings.lang.decimal + 5),
                    s.push(i),
                    s.push(
                      1 == i ? this.settings.lang.hr : this.settings.lang.hrs
                    ),
                    30 != t &&
                      n &&
          ...
          },
          {
            ...
            value: function (e) {
              if (
                null !== (e = this.settings.roundingFunction(e, this.settings))
              )
          ...
          },
          {
            ...
            value: function (e) {
              ...
              for (
                var s, a, l = "", u = 0;
                u < this.settings.timeFormat.length;
                u++
              )
                switch ((a = this.settings.timeFormat.charAt(u))) {
                  case "a":
                    l +=
                      r.getHours() > 11
                  ...
                  case "G":
                    (s = r.getHours()),
                      e === o && (s = this.settings.show2400 ? 24 : 0),
                      (l += s);
                    break;
                  case "h":
                    0 != (s = r.getHours() % 12) && s < 10 && (s = "0" + s),
                      (l += 0 === s ? "12" : s);
                    break;
                  case "H":
                    (s = r.getHours()),
            ...
            value: function () {
              ...
              if (null !== t) {
                ...
                if (i) {
                  ...
                  (this.settings.forceRoundTime || l === t) &&
          ...
          },
          {
            ...
            value: function (e, t) {
              if (
                null !== t.minTime &&
                null !== t.maxTime &&
                (e < t.minTime() || e > t.maxTime())
              )
                return !0;
              var i,
                n = l(t.disableTimeRanges);
              try {
                for (n.s(); !(i = n.n()).done; ) {
                  var r = i.value;
          ...
          },
          {
            ...
            value: function (t, i) {
              ...
              return (
                "object" == e(t)
                  ? ((n = t.label), (r = t.className), (s = t.value))
                  : "string" == typeof t
                  ? ((n = t), (s = ""))
                  : $.error("Invalid noneOption value"),
                i
                  ? ((a = document.createElement("option")).value = s)
                  : ((a = document.createElement("li")).dataset.time =
                      String(s)),
                (a.innerText = n),
                a.classList.add(r),
                a
  ...
  function g(e) {
    ...
    return (
      ...
      e.duration
        ? t.appendChild(
            document.createTextNode(e.label + " (" + e.duration + ")")
          )
  ...
  function v(e) {
    ...
    if (
      ...
      i.appendChild(document.createTextNode("(" + e.duration + ")")),
  ...
  function y(e) {
      ...
      i = [].concat(
        ...
        (function (e) {
          ...
          for (var a = [], u = r, m = 0; u <= s; m++, u += 60 * n.step(m)) {
            var d = u,
              f = e._int2time(d),
              p = d % o < 43200 ? "ui-timepicker-am" : "ui-timepicker-pm",
              h = { label: f, value: c(d, n), className: p };
            if (
              (null !== n.minTime() || null !== n.durationTime()) &&
              n.showDuration
            ) {
              var g,
                v =
                  null !== (g = n.durationTime()) && void 0 !== g
                    ? g
                    : n.minTime();
              v > u && (v -= o);
    ...
    if (
      ...
      var n,
        r = l(e.settings.className.split(" "));
      try {
        for (r.s(); !(n = r.n()).done; ) {
          var s = n.value;
          t.classList.add(s);
    ...
    return (
      !e.settings.showDuration ||
        (null === e.settings.minTime && null === e.settings.durationTime) ||
        (t.classList.add("ui-timepicker-with-duration"),
        t.classList.add("ui-timepicker-step-" + e.settings.step())),
      t
    );
  }
  !(function () {
    ...
    (m = function (t) {
      var i = {
        init: function (e) {
          return this.each(function () {
            ...
            if (
              ...
              if ((r.prop("autocomplete", "off"), l.showOn))
                for (var o in l.showOn)
                  r.on(l.showOn[o] + ".timepicker", i.show);
              r.on("change.timepicker", a._handleFormatValue),
                r.on("keydown.timepicker", s),
                r.on("keyup.timepicker", a._handleKeyUp),
                l.disableTextInput &&
                  r.on("keydown.timepicker", a._disableTextInputHandler),
        ...
        show: function (e) {
          var i = t(this),
            s = i[0].timepickerObj,
            a = s.settings;
          if ((e && e.preventDefault(), a.useSelect)) s.list.trigger("focus");
          else {
            s._hideKeyboard() && i.trigger("blur");
            var l = s.list;
            if (!i.prop("readonly") && (n(i), (l = s.list), !p.isVisible(l))) {
              i.is("input") && (s.selectedValue = i.val()),
                s._setSelected(),
                p.hideAll(),
                "number" == typeof a.listWidth &&
                  l.width(i.outerWidth() * a.listWidth),
                l.show();
              var o = {};
              a.orientation.match(/r/)
                ...
                (a.orientation.match(/t/)
                  ...
                  ? "b"
                  : i.offset().top + i.outerHeight(!0) + l.outerHeight() >
              ...
              if (!u.length) {
                ...
                null !== c
                  ? (u = t(s._findRow(c)))
                  : a.scrollDefault() && (u = t(s._findRow(a.scrollDefault())));
              }
              if (
                ((u.length && !u.hasClass("ui-timepicker-disabled")) ||
                  (u = l.find("li:not(.ui-timepicker-disabled):first")),
                u && u.length)
              ) {
              ...
              return (
                ...
                t(document).on("mousedown.ui-timepicker", r),
                window.addEventListener("resize", r),
                a.closeOnScroll &&
                  t(a.closeOnScroll).on("scroll.ui-timepicker", r),
        ...
        option: function (i, r) {
          return "string" == typeof i && void 0 === r
            ? this[0].timepickerObj.settings[i]
            : this.each(function () {
                var s = t(this),
                  a = s[0].timepickerObj,
                  l = a.settings,
                ...
                "object" == e(i)
                  ? (l = t.extend(l, i))
                  : "string" == typeof i && (l[i] = r),
                  (l = a.parseSettings(l)),
                  (a.settings = l),
                  a._formatValue({ type: "change" }, "initial"),
                  o && (o.remove(), (a.list = null)),
                  l.useSelect && n(s);
              });
        },
      ...
      function n(e) {
        ...
        if (
          ...
          a.data("timepicker-input", e),
          (n.list = a),
          s.useSelect)
        )
          e.val() && r.val(n._roundAndFormatTime(n.anytime2int(e.val()))),
            r.on("focus", function () {
              ...
              e.off("focus.timepicker"),
                e.on("focus.timepicker-ie-hack", function () {
                  e.off("focus.timepicker-ie-hack"),
                    e.on("focus.timepicker", i.show);
                }),
                n._hideKeyboard() || e[0].focus(),
      ...
      function r(e) {
        if ("focus" != e.type || e.target != window) {
          ...
          i.closest(".ui-timepicker-input").length ||
            ...
            (p.hideAll(),
            t(document).off(".ui-timepicker"),
            t(window).off(".ui-timepicker"));
        }
      }
      function s(e) {
        var n = t(this),
      ...
      (t.fn.timepicker = function (n) {
        return this.length
          ? i[n]
            ...
            : "object" !== e(n) && n
            ? void t.error(
                "Method " + n + " does not exist on jQuery.timepicker"
              )
